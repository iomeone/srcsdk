...
{
	DebugPrintf("Connecting Tier1...\n");
	ConnectTier1Libraries( &appSystemFactory, 1 );
	DebugPrintf("Connecting Tier2...\n");
	ConnectTier2Libraries( &appSystemFactory, 1 );
	DebugPrintf("Connecting Tier3...\n");
	...
	DebugPrintf("MathLib_Init()... successful!\n");
	...
	{
		DebugPrintf("PARTICLES FAILED!!!!\n");
		return false;
	}

	DebugPrintf("g_pCVar->FindVar( \"sv_cheats\" )\n");
	...
	DebugPrintf("IGameSystem::InitAllSystems()...\n");
	...
	DebugPrintf("ModelSoundsCacheInit...\n");
...
bool CServerGameDLL::LevelInit( const char *pMapName, char const *pMapEntities, char const *pOldLevel, char const *pLandmarkName, bool loadGame, bool background )
{
	...
	DebugPrintf("CServerGameDLL::LevelInit\n");
...
{
	DebugPrintf("GetAllServerClasses()\n");
...
{
	const char *desc = ::GetGameDescription();
	DebugPrintf("GetGameDescription() = %s\n", desc );
	return desc;
}
