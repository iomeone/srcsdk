...
const uint32 ALIGN16 g_SIMD_signmask[4] ALIGN16_POST = { (uint32)0x80000000, (uint32)0x80000000, (uint32)0x80000000, (uint32)0x80000000 };
const uint32 ALIGN16 g_SIMD_lsbmask[4] ALIGN16_POST = { (uint32)0xfffffffe, (uint32)0xfffffffe, (uint32)0xfffffffe, (uint32)0xfffffffe };
const uint32 ALIGN16 g_SIMD_clear_wmask[4] ALIGN16_POST = { (uint32)0xffffffff, (uint32)0xffffffff, (uint32)0xffffffff, 0 };
const uint32 ALIGN16 g_SIMD_AllOnesMask[4] ALIGN16_POST = { (uint32)0xffffffff, (uint32)0xffffffff, (uint32)0xffffffff, (uint32)0xffffffff }; // ~0,~0,~0,~0
...
{
	{ (uint32)0xFFFFFFFF, 0, 0, 0 }, { 0, (uint32)0xFFFFFFFF, 0, 0 }, { 0, 0, (uint32)0xFFFFFFFF, 0 }, { 0, 0, 0, (uint32)0xFFFFFFFF }
};

const uint32 ALIGN16 g_SIMD_SkipTailMask[4][4] ALIGN16_POST =
{
	{ (uint32)0xffffffff, (uint32)0xffffffff, (uint32)0xffffffff, (uint32)0xffffffff },
	{ (uint32)0xffffffff, (uint32)0x00000000, (uint32)0x00000000, (uint32)0x00000000 },
	{ (uint32)0xffffffff, (uint32)0xffffffff, (uint32)0x00000000, (uint32)0x00000000 },
	{ (uint32)0xffffffff, (uint32)0xffffffff, (uint32)0xffffffff, (uint32)0x00000000 },
};
