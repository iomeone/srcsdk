...
public:
	...
	inline void LCDevMsg(int lvl, const char *msg, const char *append = NULL) { if(developer.GetInt() >= lvl) { ConColorMsg(m_MsgColor, msg, append); } }
	inline void LCWarning(const char *msg, const char *append = NULL) { ConColorMsg(m_WarningColor, msg, append); }
	inline void LCDevWarning(int lvl, const char *msg, const char *append = NULL) { if(developer.GetInt() >= lvl) { ConColorMsg(m_WarningColor, msg, append); } }
	...
	void InputClearConsole( inputdata_t &inputdata ) { if(UTIL_GetLocalPlayer()) { engine->ClientCommand(UTIL_GetLocalPlayer()->edict(), "clear"); } }
...
private:
	...
	void UpdateOutValue(CBaseEntity *pActivator, const Vector &vecNewValue);
...
//-----------------------------------------------------------------------------
void CMathVector::UpdateOutValue(CBaseEntity *pActivator, const Vector &vecNewValue)
{
