...
public:
	...
	~CPhysicsNPCSolver();
	DECLARE_DATADESC();
	void Init( CBaseCombatCharacter *pNPC, CBaseEntity *pPhysicsObject, bool disableCollisions, float separationTime );
	static CPhysicsNPCSolver *Create( CBaseCombatCharacter *pNPC, CBaseEntity *pPhysicsObject, bool disableCollisions, float separationTime );
...
private:
	...
	bool IsIntersecting();
	bool IsContactOnNPCHead( IPhysicsFrictionSnapshot *pSnapshot, IPhysicsObject *pPhysics, CBaseCombatCharacter *pNPC );
	bool CheckTouching();
	friend bool NPCPhysics_SolverExists( CBaseCombatCharacter *pNPC, CBaseEntity *pPhysicsObject );

	CHandle<CBaseCombatCharacter>		m_hNPC;
	EHANDLE						m_hEntity;
...
CPhysicsNPCSolver *CPhysicsNPCSolver::Create( CBaseCombatCharacter *pNPC, CBaseEntity *pPhysicsObject, bool disableCollisions, float separationTime )
{
...
void CPhysicsNPCSolver::Init( CBaseCombatCharacter *pNPC, CBaseEntity *pPhysicsObject, bool disableCollisions, float separationTime )
{
	m_hNPC = pNPC;
...
{
	CBaseCombatCharacter *pNPC = m_hNPC.Get();
...
bool CPhysicsNPCSolver::IsContactOnNPCHead( IPhysicsFrictionSnapshot *pSnapshot, IPhysicsObject *pPhysics, CBaseCombatCharacter *pNPC )
{
	float heightCheck = pNPC->GetAbsOrigin().z + pNPC->CollisionProp()->OBBMaxs().z;
	Vector vel, point;
...
CBaseEntity *NPCPhysics_CreateSolver( CBaseCombatCharacter *pNPC, CBaseEntity *pPhysicsObject, bool disableCollisions, float separationDuration )
{
