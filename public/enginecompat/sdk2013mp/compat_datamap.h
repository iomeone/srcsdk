typedef enum _fieldtypes
{
	...
	FIELD_INTEGER64 = FIELD_INTEGER,
	FIELD_VECTOR4D = FIELD_QUATERNION,
} fieldtype_t;
	...
	float _fieldTolerance)
{
	...
	fieldOffset[0] = _fieldOffset[0];
	fieldOffset[1] = _fieldOffset[1];
...
inline datamap_t::datamap_t(
	...
	baseMap = _baseMap;
	chains_validated = _chains_validated;
	packed_offsets_computed = _packed_offsets_computed;
