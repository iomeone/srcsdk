...
#define IMPLEMENT_ELEMENT_FACTORY_INTERNAL( lookupName, className, standard )	\
	IMPLEMENT_ELEMENT( className )							\
	IMPLEMENT_ELEMENT_FACTORY_INTERNAL_FOOTER(lookupName, className, standard)

#define IMPLEMENT_ELEMENT_FACTORY_INTERNAL_TEMPLATE( lookupName, className, standard )	\
	IMPLEMENT_ELEMENT_TEMPLATE( className )							\
	IMPLEMENT_ELEMENT_FACTORY_INTERNAL_FOOTER(lookupName, className, standard)

#define IMPLEMENT_ELEMENT_FACTORY_INTERNAL_FOOTER( lookupName, className, standard )	\
	CDmElementFactory< className > g_##className##_Factory( #lookupName );							\
	CDmElementFactoryHelper g_##className##_Helper( #lookupName, &g_##className##_Factory, standard );	\
...
#define IMPLEMENT_ELEMENT_FACTORY( lookupName, className )	\
	IMPLEMENT_ELEMENT_FACTORY_INTERNAL(lookupName, className, true) 

#define IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( lookupName, className )	\
	IMPLEMENT_ELEMENT_FACTORY_INTERNAL_TEMPLATE(lookupName, className, true) 
...
#define IMPLEMENT_ELEMENT_FACTORY( lookupName, className )	\
	IMPLEMENT_ELEMENT_FACTORY_INTERNAL(lookupName, className, false) 

#define IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( lookupName, className )	\
	IMPLEMENT_ELEMENT_FACTORY_INTERNAL_TEMPLATE(lookupName, className, false) 
