...
private:
	// Array of images in an animated texture
	CDmaElementArray< CDmeImage > m_ImagesPosX;
	CDmaElementArray< CDmeImage > m_ImagesNegX;
	CDmaElementArray< CDmeImage > m_ImagesPosY;
	CDmaElementArray< CDmeImage > m_ImagesNegY;
	CDmaElementArray< CDmeImage > m_ImagesPosZ;
	CDmaElementArray< CDmeImage > m_ImagesNegZ;
};
