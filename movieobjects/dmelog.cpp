...
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeIntLogLayer,			CDmeIntLogLayer );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeFloatLogLayer,		CDmeFloatLogLayer );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeBoolLogLayer,			CDmeBoolLogLayer );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeColorLogLayer,		CDmeColorLogLayer );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeVector2LogLayer,		CDmeVector2LogLayer );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeVector3LogLayer,		CDmeVector3LogLayer );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeVector4LogLayer,		CDmeVector4LogLayer );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeQAngleLogLayer,		CDmeQAngleLogLayer );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeQuaternionLogLayer,	CDmeQuaternionLogLayer );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeVMatrixLogLayer,		CDmeVMatrixLogLayer );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeStringLogLayer,		CDmeStringLogLayer );
...
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeIntCurveInfo,			CDmeIntCurveInfo );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeFloatCurveInfo,		CDmeFloatCurveInfo );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeBoolCurveInfo,		CDmeBoolCurveInfo );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeColorCurveInfo,		CDmeColorCurveInfo );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeVector2CurveInfo,		CDmeVector2CurveInfo );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeVector3CurveInfo,		CDmeVector3CurveInfo );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeVector4CurveInfo,		CDmeVector4CurveInfo );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeQAngleCurveInfo,		CDmeQAngleCurveInfo );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeQuaternionCurveInfo,	CDmeQuaternionCurveInfo );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeVMatrixCurveInfo,		CDmeVMatrixCurveInfo );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeStringCurveInfo,		CDmeStringCurveInfo );
...
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeIntLog,			CDmeIntLog );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeFloatLog,			CDmeFloatLog );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeBoolLog,			CDmeBoolLog );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeColorLog,			CDmeColorLog );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeVector2Log,		CDmeVector2Log );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeVector3Log,		CDmeVector3Log );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeVector4Log,		CDmeVector4Log );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeQAngleLog,		CDmeQAngleLog );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeQuaternionLog,	CDmeQuaternionLog );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeVMatrixLog,		CDmeVMatrixLog );
IMPLEMENT_ELEMENT_FACTORY_TEMPLATE( DmeStringLog,		CDmeStringLog );
...
template< >
void SpewKey( const VMatrix& val )
{
	Msg( "[%f %f %f %f]", val.m[0][0], val.m[0][1], val.m[0][2], val.m[0][3] );
	Msg( "[%f %f %f %f]", val.m[1][0], val.m[1][1], val.m[1][2], val.m[1][3] );
	Msg( "[%f %f %f %f]", val.m[2][0], val.m[2][1], val.m[2][2], val.m[2][3] );
	Msg( "[%f %f %f %f]", val.m[3][0], val.m[3][1], val.m[3][2], val.m[3][3] );
}
