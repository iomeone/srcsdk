...
inline void SoundInfo_t::ReadDelta( SoundInfo_t *delta, bf_read &buffer, int nProtoVersion )
{
...
inline void SoundInfo_t::WriteDelta( SoundInfo_t *delta, bf_write &buffer)
{
