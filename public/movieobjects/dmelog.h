...
template<> bool CDmeTypedLog< Vector >::ValuesDiffer( const Vector& a, const Vector& b ) const;
template<> bool CDmeTypedLog< QAngle >::ValuesDiffer( const QAngle& a, const QAngle& b ) const;
template<> bool CDmeTypedLog< Quaternion >::ValuesDiffer( const Quaternion& a, const Quaternion& b ) const;
template<> bool CDmeTypedLog< float >::ValuesDiffer( const float& a, const float& b ) const;

template <> float CDmeTypedLog<int>::s_defaultThreshold;
template <> float CDmeTypedLog<float>::s_defaultThreshold;
template <> float CDmeTypedLog<bool>::s_defaultThreshold;
template <> float CDmeTypedLog<Color>::s_defaultThreshold;
template <> float CDmeTypedLog<Vector2D>::s_defaultThreshold;
template <> float CDmeTypedLog<Vector>::s_defaultThreshold;
template <> float CDmeTypedLog<Vector4D>::s_defaultThreshold;
template <> float CDmeTypedLog<QAngle>::s_defaultThreshold;
template <> float CDmeTypedLog<Quaternion>::s_defaultThreshold;
template <> float CDmeTypedLog<VMatrix>::s_defaultThreshold;
template <> float CDmeTypedLog<CUtlString>::s_defaultThreshold;
