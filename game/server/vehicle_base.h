...
public:
	...
	// NPC Driving
	void					NPC_SetDriver( CBaseCombatCharacter *pDriver );
...
{
public:
	virtual bool	NPC_CanEnterVehicle( CBaseCombatCharacter *pPassenger, bool bCompanion ) = 0;
	virtual bool	NPC_CanExitVehicle( CBaseCombatCharacter *pPassenger, bool bCompanion ) = 0;
	virtual bool	NPC_AddPassenger( CBaseCombatCharacter *pPassenger, string_t strRoleName, int nSeatID ) = 0;
	virtual bool	NPC_RemovePassenger( CBaseCombatCharacter *pPassenger ) = 0;
	virtual void	NPC_FinishedEnterVehicle( CBaseCombatCharacter *pPassenger, bool bCompanion ) = 0;
	virtual void	NPC_FinishedExitVehicle( CBaseCombatCharacter *pPassenger, bool bCompanion ) = 0;
};
...
public:
	...
	// NPC Driver
	CHandle<CBaseCombatCharacter>	 m_hNPCDriver;
...
public:
	...
	virtual bool	NPC_CanEnterVehicle( CBaseCombatCharacter *pPassenger, bool bCompanion );
	virtual bool	NPC_CanExitVehicle( CBaseCombatCharacter *pPassenger, bool bCompanion );
	virtual bool	NPC_AddPassenger( CBaseCombatCharacter *pPassenger, string_t strRoleName, int nSeatID );
	virtual bool 	NPC_RemovePassenger( CBaseCombatCharacter *pPassenger );
	virtual void	NPC_FinishedEnterVehicle( CBaseCombatCharacter *pPassenger, bool bCompanion ) {} 
	virtual void	NPC_FinishedExitVehicle( CBaseCombatCharacter *pPassenger, bool bCompanion ) {}
