...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CPropVehicleDriveable::NPC_CanEnterVehicle( CBaseCombatCharacter *pPassenger, bool bCompanion )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CPropVehicleDriveable::NPC_CanExitVehicle( CBaseCombatCharacter *pPassenger, bool bCompanion )
{
	// Always allowed unless a leaf class says otherwise
	return true;
}
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CPropVehicleDriveable::NPC_AddPassenger( CBaseCombatCharacter *pPassenger, string_t strRoleName, int nSeatID )
{
...
//			bCompanion - 
//-----------------------------------------------------------------------------
bool CPropVehicleDriveable::NPC_RemovePassenger( CBaseCombatCharacter *pPassenger )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CFourWheelServerVehicle::NPC_SetDriver( CBaseCombatCharacter *pDriver )
{
	if ( pDriver )
	{
		m_nNPCButtons = 0;
