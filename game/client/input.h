...
//	virtual		bool		IsNoClipping( void );
	...
	virtual void ForceFeedback_StopAll();
	virtual void ForceFeedback_Stop( int effectnum ) ;
	virtual void ForceFeedback_Start( int effectnum, const struct FFBaseParams_t& params ) ;
	virtual void ForceFeedback_Pause() ;
	virtual void ForceFeedback_Resume() ;

// Private Implementation
protected:
	void Init_ForceFeedback();
	void Shutdown_ForceFeedback();
	void ForceFeedback_Reaquire();
	void ForceFeedback_Think();
...
// Private Data
private:
	struct ForceFeedbackParams_t *m_pFF;
