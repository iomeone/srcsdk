...
#define DEFAULT_TICK_INTERVAL	(1.0f / 60.0f)				// 15 msec is the default
#define MINIMUM_TICK_INTERVAL   (0.001)
#define MAXIMUM_TICK_INTERVAL	(0.1)

#include "compat_const.h"
...
enum SolidFlags_t
{
	...
	FSOLID_TRIGGER_TOUCH_PLAYER	= 0x0800,	// This trigger will touch only players
	FSOLID_NOT_MOVEABLE			= 0x1000,	// Assume this object will not move
