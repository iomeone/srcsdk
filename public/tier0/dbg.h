	...
	#define  _AssertMsg( _exp, _msg, _executeExp, _bFatal )	\
		do {																\
			...
			{ 																\
				...
				SpewRetval_t ret = _SpewMessage("%s", (const tchar *)_msg);				\
...
#ifdef _DEBUG
#ifdef ANDROID
#define DebugPrintf(...) android_printf(__VA_ARGS__)
#else
#define DebugPrintf(...) DevMsg(__VA_ARGS__)
#endif
#else
#define DebugPrintf(...) 
#endif
