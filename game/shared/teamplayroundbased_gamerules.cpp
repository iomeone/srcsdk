...
void CTeamplayRoundBasedRules::State_Think_RND_RUNNING( void )
{
	...
	{
		if ( m_bAllowStalemateAtTimelimit || ( mp_match_end_at_timelimit.GetBool() && !IsOfficialMap() ) )
		{
...
void CTeamplayRoundBasedRules::CreateTimeLimitTimer( void )
{
	...
	bool bAllowStalemate = ( m_bAllowStalemateAtTimelimit || ( mp_match_end_at_timelimit.GetBool() && !IsOfficialMap() ) );
	if ( !bAllowStalemate )
		return;
