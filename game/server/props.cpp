...
void CPhysicsProp::HandleAnyCollisionInteractions( int index, gamevcollisionevent_t *pEvent )
{
	...
	if ( HasInteraction( PROPINTER_PHYSGUN_FIRST_IMPALE ) )
	{
		...
		{
			CBaseCombatCharacter *pNPC = pHitEntity->MyCombatCharacterPointer();
			IPhysicsObject *pObj = VPhysicsGetObject();
...
// Input  : *pNPC -
//-----------------------------------------------------------------------------
bool CBasePropDoor::NPCOpenDoor( CBaseCombatCharacter *pNPC )
{
...
public:
	...
	void	GetNPCOpenData(CBaseCombatCharacter *pNPC, opendata_t &opendata);
...
//			opendata -
//-----------------------------------------------------------------------------
void CPropDoorRotating::GetNPCOpenData(CBaseCombatCharacter *pNPC, opendata_t &opendata)
{
