...
public:
	...
	virtual void ForceFeedback_StopAll() = 0;
	virtual void ForceFeedback_Stop( int effectnum ) = 0;
	virtual void ForceFeedback_Start( int effectnum, const struct FFBaseParams_t& params ) = 0;
	virtual void ForceFeedback_Pause() = 0;
	virtual void ForceFeedback_Resume() = 0;
};
