...
public:
	...
	FMTFUNCTION_WIN( 3, 4 ) virtual void			ConsoleColorPrintf( const Color& clr, PRINTF_FORMAT_STRING const char *pFormat, ... ) const = 0;
	FMTFUNCTION_WIN( 2, 3 ) virtual void			ConsolePrintf( PRINTF_FORMAT_STRING const char *pFormat, ... ) const = 0;
	FMTFUNCTION_WIN( 2, 3 ) virtual void			ConsoleDPrintf( PRINTF_FORMAT_STRING const char *pFormat, ... ) const = 0;
