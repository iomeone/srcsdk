...
ConVar r_threaded_client_shadow_manager( "r_threaded_client_shadow_manager", "1", FCVAR_ARCHIVE, "", ThreadedShadowMGRCallback);
...
bool CClientShadowMgr::Init()
{
	...
	int iNumShadows = CommandLine()->ParmValue( "-numshadowtextures", (r_max_shadowtextures.GetInt() > 0) ? r_max_shadowtextures.GetInt() : 5 );
