...
public:
	...
	virtual void GetNPCOpenData(CBaseCombatCharacter *pNPC, opendata_t &opendata) = 0;
...
bool CBasePropDoor::IsNPCOpening( CBaseCombatCharacter *pNPC )
{
	return ( pNPC == ( CBaseCombatCharacter * )GetActivator() );
}
