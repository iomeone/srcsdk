...
using LPDIRECTINPUTEFFECT = void *;
#define CALLBACK 
using LPCDIFILEEFFECT = void *;
using LPVOID = void *;
#endif
...
static void DescribeFFDevice( const struct DIDEVCAPS& caps )
{
#ifdef _WIN32
...
{ 
	...
	HWND mainWnd = NULL;//(HWND)g_pEngineWindow->GetWindowHandle();
